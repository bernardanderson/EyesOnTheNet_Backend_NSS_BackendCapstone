...
namespace EyesOnTheNet
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseCors(builder =>
                builder
                .WithOrigins("http://192.168.56.102", "http://192.168.56.102:4200", "http://192.168.56.102:5000", "http://192.168.0.229", "http://192.168.0.229:4200", "http://192.168.0.229:5000").AllowCredentials().AllowAnyHeader().AllowAnyMethod()  // For a specific domain
